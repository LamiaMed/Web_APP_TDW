<?php
require_once('../MVC/Controller/ControllerContact.php');
?>
<style>
...
?>
  ...
  public function afficher_coordonnees()
  {
    ...
    $res = $c->coordonnees();
  ?>
    <div class="card" style="margin:2%; margin-left:20%;margin-right:20%;text-align: center;">
      <div class="card-header" style="font-family:Verdana, Geneva, Tahoma, sans-serif; background-color: 039FC0;">
        <h5 class="card-title" style="  font-weight: bold; color:white"> Nous contacter</h5>
      </div>
      <div class="card-body" style="     background-color: C5FFFF;  ">
        <blockquote class="blockquote mb-0">
          <?php foreach ($res as $row) {
            echo '<p>' . $row["titre"] . ' ' . $row["information"] . '</p>';
          }
          ?>
        </blockquote>
      </div>
