<?php
require_once('../MVC/Controller/ControllerMoyen.php');
?>
<style>
    ...
    ?>
        ...
        <div class="card text-black " style="max-width: 23% ;margin-right:2%;">
          ...
          <div class="card-body">
            ...
            if ($row["titre"] === 'Liste ENS') {
              echo '<a href="/projet/index/Cycles/Moyen/Liste ENS" style="color: blue;">Consulter</a>';
            } else if ($row["titre"] === 'EDT') {
              echo '<a href="/projet/index/Cycles/Moyen/EDT" style="color: blue;">Consulter</a>';
            } elseif ($row["titre"] === 'Restauration') {
              echo '<a href="/projet/index/Cycles/Moyen/Rest" style="color: blue; ">Consulter</a>';
            } else {
              echo '<a href="/projet/index/Cycles/Moyen" style="color: blue;">Consulter</a>';
            }
            ?>
          </div>
        </div>
        ...
        <div class="card text-black " style="max-width: 23% ;margin-right:2%;">
          <div class="card-body">
            ...
            <?php echo '<p class="card-text">' . $row["description"] . '</p>';
            if ($row["titre"] === 'Liste ENS') {
              echo '<a href="/projet/index/Cycles/Moyen/Liste ENS" style="color: white;">Consulter</a>';
            } else  if ($row["titre"] === 'EDT') {
              echo '<a href="/projet/index/Cycles/Moyen/EDT" style="color: white;">Consulter</a>';
            } else {
              echo '<a href="/projet/index/Cycles/Moyen" style="color: blue;">Consulter</a>';
            }
            ?>
