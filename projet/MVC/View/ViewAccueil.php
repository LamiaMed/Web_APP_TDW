...
class ViewAccueil
{
  ...
  public function afficher_diaporama()
  {
    ...
    foreach ($res as $row) {
      ...
      echo '<li class="sliderAnimation"> <img  style="width: 65%;height: 150%;" src="../MVC/Image/' . $row["link"] . '"></li>';
    }
    echo '</ul></div>';
  }
...
?>
  ...
  public function afficher_articleUP()
  {
    ...
    ?>
        ...
        <div class="card text-black " style="max-width: 23% ;margin-right:2%;">
          ...
          <div class="card-body">
            ...
            <?php echo ' <img src="../MVC/Image/article/' . $row["image"] . '" style="width: 100%;"</img>'; ?>
