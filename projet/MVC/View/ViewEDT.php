<?php
require_once('../MVC/Controller/ControllerEDT.php');
?>
<style>
...
?>
  ...
  public function afficher_EDT_P()
  {
    ...
    $old = 0;
  ?>
    <h5 style="margin-bottom : 3%; text-align:center; margin-top:2%;">Consultez les emplois du temps pour les groupes du cycle Primaire: </h5>
    <div class="container">
