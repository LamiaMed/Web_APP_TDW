...
require_once('../MVC/Controller/ControllerParent.php');

require_once('../MVC/Model/ModelParent.php');
?>
    ...
    ?>
        ...
        <div class="card text-black" style="max-width: 23% ;margin-right:2%;">
          <div class="card-body">
            ...
            <?php echo '<p class="card-text"><a href="./Parent">Consulter</a></p>'; ?>
          </div>
        </div>
  ...
  public function login()
  {
    ...
    if (isset($_POST['username'])) {
      ...
      if ($count == 1) {
        ...
        header('Location: ./Parent/information/' . $username . '/' . $matricule . '');
      } else {
      ?>
        <script>
