<?php
require_once('../MVC/Controller/ControllerPrimaire.php');
?>
<style>
        ...
        <div class="card text-black " style="max-width: 23% ;margin-right:2%;">
          ...
          <div class="card-body">
            ...
            if ($row["titre"] === 'Liste ENS') {
              echo '<a href="/projet/index/Cycles/Primaire/Liste ENS" style="color: blue;">Consulter</a>';
            } else if ($row["titre"] === 'EDT') {
              echo '<a href="/projet/index/Cycles/Primaire/EDT" style="color: blue; ">Consulter</a>';
            } elseif ($row["titre"] === 'Restauration') {
              echo '<a href="/projet/index/Cycles/Primaire/Rest" style="color: blue; ">Consulter</a>';
            } else {
              echo '<a href="./Primaire" style="color: blue; ">Consulter</a>';
            }
